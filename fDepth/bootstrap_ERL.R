...
print('Running bootstrap_EXL.R with bootstrap confidence bands ...')
...
for (i in 1:n_bands) {
  ...
  for (j in 1:n_bootstrap_interations) {
    ...
    depth_scores_   = extreme_rank_length(bootstrap_curves_, type = "two_sided")
...
depth_scores_  = extreme_rank_length(bootstrap_curves_)
